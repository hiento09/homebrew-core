class Cortexso < Formula
  ...
  def caveats
    <<~EOS
      When uninstalling cortexso, please manually follow these steps:
      - Before uninstalling, stop the running cortexso server by running `cortex stop`
      - Delete the cortex data directory by running `rm -rf ~/cortex`
    EOS
  end
